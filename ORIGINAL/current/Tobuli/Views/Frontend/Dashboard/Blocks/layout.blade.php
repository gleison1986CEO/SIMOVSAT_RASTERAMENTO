<div style="border-radius:20px;"class="dashboard-block @yield('width', 'col-sm-6 col-md-4 col-lg-3')" id="{{ "block_$name" }}">
    <div class="panel panel-default" id="painel_grafico_">
        <div class="panel-heading" id="painel_titulo_grafico">
