<div class="tab-pane-header">
    <div id="history-form" class="form-horizontal">
        <div class="form-group">
            <label class="col-xs-3 control-label">Rastreador:</label>
            <div class="col-xs-9">
        ...
        <div class="form-group">
            <label class="col-xs-3 control-label">Até:</label>
            <div class="col-xs-9">
                <div class="input-group">
        ...
        <div class="input-group">
            <button class="btn btn-primary btn-block" id="button_"type="button" onclick="app.history.get()">Mostrar histórico</button>
            <span class="input-group-btn">
