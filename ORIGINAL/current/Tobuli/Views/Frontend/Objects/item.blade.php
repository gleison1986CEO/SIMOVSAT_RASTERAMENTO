...
<!-- PLACA - NOME - ETC -->
    ...
    -->
        <span data-device="plate_number">{{ $item->plate_number }}</span></br>
        <span id="text_data_notes" data-device="additional_notes">{{$item->additional_notes}}</span></br>
        <span id="text_data_notes" data-device="name">{{ $item->name }}</span></br>
    </div>
<!-- PLACA - NOME - ETC -->    
    <div class="details">
