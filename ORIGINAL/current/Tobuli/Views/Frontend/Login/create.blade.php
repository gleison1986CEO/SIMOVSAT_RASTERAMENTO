...
@section('content')
    ...
    <div class="panel" id="painel_">
        <div class="panel-background" id="painel_"></div>
        <div class="panel-body" id="body_form_">

            @if ( Appearance::assetFileExists('logo-main') )
            <a href="{{ route('home') }}">
                <img class="img-responsive center-block" src="https://simovsat.com.br/images/logo-main.png?t=1684507439" alt="Logo">
            </a>
            @endif
            ...
            {!! Form::open(array('route' => 'authentication.store', 'class' => 'form')) !!}
                ...
                <div class="form-group">
                    <div class="checkbox" id="checkbox_">
                ...
                <button class="btn btn-lg btn-primary btn-block"  id="button_"name="Submit" value="Login" type="Submit">{!! trans('front.sign_in') !!}</button>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            <a href="{!! route('password_reminder.create') !!}" id="button_2" class="btn btn-block btn-lg btn-default">{!! trans('front.cant_sign_in') !!}</a>
                        </div>
                        <div class="col-sm-12">
            ...
            {!! Form::close() !!}
            Simovsat empresa especializada em rastreamento e monitoramento veicular 24h  | 2025 LTDA
        </div> 
    </div>
