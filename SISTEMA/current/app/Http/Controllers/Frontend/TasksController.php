...
class TasksController extends Controller {
    ...
    public function search()
    {
        ...
        $data = [
            ...
            'statuses' => array_map(function($value) { return trans($value);}, TaskStatus::$statuses),
        ];
    ...
    public function getStatuses() {
        return response()->json([
            'status' => 1,
            'items'  => toOptions( array_map(function($value) { return trans($value);}, TaskStatus::$statuses) )
        ]);
    }
