            ...
            <div class="row">
                <div class="col-sm-6">
                    @if(Auth::user()->can('view', $item, 'sim_number'))
                        <div class="form-group">
                            <span style="color: black !important"> Número SIM</span> 
                   ...
                   <div class="form-group">
                        <span style="color: black !important"> Data de ativação do SIM</span> 
                        ...
                        <div class="form-group">
                        <span style="color: black !important"> Data de validade do SIM</span> 
                    ...
                    <div class="form-group">
                    <span style="color: black !important"> Modelo do dispositivo</span> 
                ...
                <div class="col-sm-6">
                    ...
                    <!--<div class="form-group">
                    <span style="color: black !important"> Carteira de motorista</span> 
                        {!!Form::text('registration_number', $item->registration_number, ['class' => 'form-control'])!!}
                    </div>
                   -->
                    <!--<div class="form-group">
                    <span style="color: black !important">Proprietário</span> 
                        {!!Form::text('object_owner', $item->object_owner, ['class' => 'form-control'])!!}
                    </div>-->
                    <div class="form-group">
                    <span style="color: black !important"> Tabela fipe</span> 
                        {!!Form::text('tabela_fipe', $item->tabela_fipe, ['class' => 'form-control'])!!}
                    </div>
                </div>
            </div>
