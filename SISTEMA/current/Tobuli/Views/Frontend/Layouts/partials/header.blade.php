    ...
    <nav class="navbar main-navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/" title="{{ Appearance::getSetting('server_name') }}"><img src="https://simovsat.com.br/images/logo-main.png?t=1684507439"></a>
                @endif
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-left" role="menu" aria-labelledby="dropTools">
                            @if ( Auth::User()->perm('simovsat', 'view') )
                            <li>
                                simovsat.com.br
                            </li>
                            @endif
                            ...
                            <li>
                                <a href="javascript:" data-url="{{ route('sharing.index') }}" data-modal="sharing">
                                    ...
                                    <span class="text">compartilhamento</span>
                                </a>
                            </li>
                            @endif
