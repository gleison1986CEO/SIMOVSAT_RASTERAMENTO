...
<link rel="shortcut icon" href="http://atise.website/SIMOVSAT/APP/imagens/ic.png" type="image/x-icon">
<link rel="stylesheet" href="{{ asset_resource('assets/css/'.Appearance::getSetting('template_color').'.css') }}">
<link rel="stylesheet" href="{{ asset_resource('assets/css/novo_css.css') }}">
@if (Language::dir() == 'rtl')
