        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div id="card_edit_form" >
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('import_parse_rastreadores') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('csv_file') ? ' has-error' : '' }}">
                            ...
                            <center> <p>* baixe o gabarito de importacao de dados do chip ou rastreador em csv  <a href="https://drive.google.com/drive/folders/1H-F2GB3gmSZStCWZ1hKYJDTWH_27lpzv?usp=sharing">'donwload'</a></p></center>
                        </form>
                    </div>
