...
<div id="menu_div_fechar">
                      ...
                      <a href="http://atise.website/SIMOVSAT/APP/importar_dados_sistema_sga_para_atise.php" class="btn text-white me-0" id="button_simovsat"  ><i      id="icones_menu"class="fa fa-cloud-upload"  aria-hidden="true"></i>   <spa id="fonte_menu">importar usuario</spa></a>
                      <a href="http://atise.website/SIMOVSAT/APP/importar_veiculos_SGA.php"    class="btn text-white me-0" id="button_simovsat"               ><i      id="icones_menu"class="fa fa-cloud-upload"  aria-hidden="true"></i>   <spa id="fonte_menu">importar veiculo</spa></a>
...
<h1 style="font-size:50px; font-weight:bold !important; color:#595959 !important;"><?php 
if ($conectados == ''){echo 0;}else{ echo $conectados;}
?></h1>
</div>
